...
/**
 * Mobile navbar: responsive header with hamburger menu and GSAP animations.
 * Shown on mobile and tablet screens (below lg breakpoint).
...
export function MobileNavbar() {
  ...
  return (
    <>
      <header
        className={cn(
          "navbar-gradient-border sticky top-0 z-50 block w-full transition-colors duration-300 lg:hidden",
          isLightBar
